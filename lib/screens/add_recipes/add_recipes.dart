                      ...
                      Container(
                          ...
                          child:TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                labelText: "Numbered Steps (separated by comma)",
...
*/
  ...
  void CheckInput(){
    if (_titleTextController.text == ""){
      ...
      setState(() {
        error = "Enter ingredients needed for the dish";
      });
    }
  ...
  getIcon() {
    if (url == 'assets/images/emptyFood.jpg'){
      return IconButton(icon: Icon(Icons.cloud_upload_outlined), iconSize: 50, onPressed: () => {AddImages()},);
    }
    else{
      return IconButton(icon: Image.network(url), iconSize: 150, onPressed: () => {AddImages()},);
    }
  }
