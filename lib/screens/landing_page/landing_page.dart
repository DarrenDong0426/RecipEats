                ...
                Container(
                  child:
                      Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: <Widget>[
                          Text("Best way to share and find recipes!", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17,color: hexStringToColor('3c403a')),),
                          SizedBox(height: 20),
                  Container(
                    width: MediaQuery.of(context).size.width,
                    height: 50,
                      ...
                      style: ButtonStyle(
                          backgroundColor: MaterialStateProperty.resolveWith((states) {
                            if (states.contains(MaterialState.pressed)) {
                              return Color(0xff627f68).withOpacity(0.7);
                            }
                            return Color(0xff627f68).withOpacity(0.7);
                          }),
                          ...
                          Container(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text(
                                "Sign In",
                                style: TextStyle(
                                    color: hexStringToColor('3c403a'), fontWeight: FontWeight.bold, fontSize: 16),
                              ),
                              style: ButtonStyle(
