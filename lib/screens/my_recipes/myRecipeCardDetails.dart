          ...
          Container(
            ...
            child: SingleChildScrollView(
              ...
              Column(
                ...
                children: <Widget>[
                  Image(image: Image.network(url).image, height: 300,  width: double.infinity,
                    fit: BoxFit.fitWidth,),
                  Container(
                      ...
                      /** Container(
                        ...
                        child: ElevatedButton(
                          ...
                          Padding(
                            ...
                            Row(
                                ...
                                <Widget>[
                                  ...
                                  Align(
                                      alignment: Alignment.centerLeft,
                                      child: Text(data["prepTime"] + " minutes", style: TextStyle(fontSize: 17))
                         ...
                         /* Padding(
                          ...
                          Padding(
                            padding: EdgeInsets.fromLTRB(25, 5, 25, 0),
                            child: Text(data["tags"].toString().substring(1, (data["tags"].toString().length - 1)),  style: TextStyle(fontSize: 17)),
                          ),
                          Padding(
